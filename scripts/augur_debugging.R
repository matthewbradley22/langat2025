#Function code taken from https://github.com/neurorestore/Augur/blob/master/R/calculate_auc.R
library(tester)
library(parallel)
library(purrr)

input = cerebrum_lgtv_wt
meta = NULL
label_col = "label"
...
#Keeping above vectors with same names to remember options 
classifier = 'rf'
